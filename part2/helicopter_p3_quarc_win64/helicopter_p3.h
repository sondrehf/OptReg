 ...
 * '<S7>'   : 'helicopter_p3/Pitch controller'
 * '<S8>'   : 'helicopter_p3/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter_p3/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter_p3/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter_p3/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter_p3/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter_p3/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter_p3/Helicopter_interface/Travel rate  rad to deg'
 */
