...
#ifndef RTW_HEADER_helicopter_p2_h_
#define RTW_HEADER_helicopter_p2_h_
#include <math.h>
#include <string.h>
#ifndef helicopter_p2_COMMON_INCLUDES_
# define helicopter_p2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter_p2_COMMON_INCLUDES_ */

#include "helicopter_p2_types.h"
...
#define helicopter_p2_rtModel          RT_MODEL_helicopter_p2_T
...
#define rtB                            helicopter_p2_B
#define BlockIO                        B_helicopter_p2_T
#define rtX                            helicopter_p2_X
#define ContinuousStates               X_helicopter_p2_T
#define rtXdot                         helicopter_p2_XDot
#define StateDerivatives               XDot_helicopter_p2_T
#define tXdis                          helicopter_p2_XDis
#define StateDisabled                  XDis_helicopter_p2_T
#define rtP                            helicopter_p2_P
#define Parameters                     P_helicopter_p2_T
#define rtDWork                        helicopter_p2_DW
#define D_Work                         DW_helicopter_p2_T

/* Parameters (auto storage) */
struct P_helicopter_p2_T_ {
...
struct tag_RTM_helicopter_p2_T {
  const char_T *path;
...
extern P_helicopter_p2_T helicopter_p2_P;

/* Block signals (auto storage) */
extern B_helicopter_p2_T helicopter_p2_B;

/* Continuous states (auto storage) */
extern X_helicopter_p2_T helicopter_p2_X;

/* Block states (auto storage) */
extern DW_helicopter_p2_T helicopter_p2_DW;

/* Model entry point functions */
extern void helicopter_p2_initialize(void);
extern void helicopter_p2_output(void);
extern void helicopter_p2_update(void);
extern void helicopter_p2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_p2_rtModel *helicopter_p2(void);
...
extern RT_MODEL_helicopter_p2_T *const helicopter_p2_M;
 ...
 *
 * '<Root>' : 'helicopter_p2'
 * '<S1>'   : 'helicopter_p2/Conversion'
 * '<S2>'   : 'helicopter_p2/Degrees to Radians'
 * '<S3>'   : 'helicopter_p2/Degrees to Radians1'
 * '<S4>'   : 'helicopter_p2/Degrees to Radians2'
 * '<S5>'   : 'helicopter_p2/Elevation controller'
 * '<S6>'   : 'helicopter_p2/Helicopter_interface'
 * '<S7>'   : 'helicopter_p2/Pitch controller'
 * '<S8>'   : 'helicopter_p2/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter_p2/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter_p2/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter_p2/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter_p2/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter_p2/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter_p2/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_p2_h_ */
