...
#ifndef RTW_HEADER_helicopter_p3_h_
#define RTW_HEADER_helicopter_p3_h_
#include <math.h>
#include <string.h>
#ifndef helicopter_p3_COMMON_INCLUDES_
# define helicopter_p3_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter_p3_COMMON_INCLUDES_ */

#include "helicopter_p3_types.h"
...
#define helicopter_p3_rtModel          RT_MODEL_helicopter_p3_T
...
typedef struct {
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } FromWorkspace_PWORK;               /* '<S7>/From Workspace' */
  ...
  struct {
    int_T PrevIndex;
  } FromWorkspace_IWORK;               /* '<S7>/From Workspace' */
...
#define rtB                            helicopter_p3_B
#define BlockIO                        B_helicopter_p3_T
#define rtX                            helicopter_p3_X
#define ContinuousStates               X_helicopter_p3_T
#define rtXdot                         helicopter_p3_XDot
#define StateDerivatives               XDot_helicopter_p3_T
#define tXdis                          helicopter_p3_XDis
#define StateDisabled                  XDis_helicopter_p3_T
#define rtP                            helicopter_p3_P
#define Parameters                     P_helicopter_p3_T
#define rtDWork                        helicopter_p3_DW
#define D_Work                         DW_helicopter_p3_T

/* Parameters (auto storage) */
struct P_helicopter_p3_T_ {
  real_T K_T[4];                       /* Variable: K_T
...
struct tag_RTM_helicopter_p3_T {
  const char_T *path;
...
extern P_helicopter_p3_T helicopter_p3_P;

/* Block signals (auto storage) */
extern B_helicopter_p3_T helicopter_p3_B;

/* Continuous states (auto storage) */
extern X_helicopter_p3_T helicopter_p3_X;

/* Block states (auto storage) */
extern DW_helicopter_p3_T helicopter_p3_DW;

/* Model entry point functions */
extern void helicopter_p3_initialize(void);
extern void helicopter_p3_output(void);
extern void helicopter_p3_update(void);
extern void helicopter_p3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_p3_rtModel *helicopter_p3(void);
...
extern RT_MODEL_helicopter_p3_T *const helicopter_p3_M;
 ...
 *
 * '<Root>' : 'helicopter_p3'
 * '<S1>'   : 'helicopter_p3/Conversion'
 * '<S2>'   : 'helicopter_p3/Degrees to Radians'
 * '<S3>'   : 'helicopter_p3/Degrees to Radians1'
 * '<S4>'   : 'helicopter_p3/Degrees to Radians2'
 * '<S5>'   : 'helicopter_p3/Elevation controller'
 * '<S6>'   : 'helicopter_p3/Helicopter_interface'
 * '<S7>'   : 'helicopter_p3/LQR-controller'
 * '<S8>'   : 'helicopter_p3/Pitch controller'
 * '<S9>'   : 'helicopter_p3/Helicopter_interface/Elevation rad to deg'
 * '<S10>'  : 'helicopter_p3/Helicopter_interface/Elevation rate rad to deg'
 * '<S11>'  : 'helicopter_p3/Helicopter_interface/Pitch rad to deg'
 * '<S12>'  : 'helicopter_p3/Helicopter_interface/Pitch rate rad to deg'
 * '<S13>'  : 'helicopter_p3/Helicopter_interface/Pitch rate rad to deg1'
 * '<S14>'  : 'helicopter_p3/Helicopter_interface/Travel rad to deg'
 * '<S15>'  : 'helicopter_p3/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_p3_h_ */
