  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (helicopter_with_feedback_P)
    ;%
      section.nData     = 26;
      section.data(26)  = dumData; %prealloc
      
	  ;% helicopter_with_feedback_P.K_T
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_with_feedback_P.K_ed
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 12;
	
	  ;% helicopter_with_feedback_P.K_ei
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 13;
	
	  ;% helicopter_with_feedback_P.K_ep
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 14;
	
	  ;% helicopter_with_feedback_P.K_pd
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 15;
	
	  ;% helicopter_with_feedback_P.K_pp
	  ...
	  ;% helicopter_with_feedback_P.travel_gain
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_set_other_outputs
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 31;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_other_outpu_m
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 32;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_other_outpu_k
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 33;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_other_outpu_j
	  ...
	  ;% helicopter_with_feedback_P.HILReadEncoderTimebase_clock
	  section.data(1).logicalSrcIdx = 26;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_with_feedback_P.HILInitialize_hardware_clocks
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_watchdog_digital_
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_analog_input_chan
	  ...
	  ;% helicopter_with_feedback_P.HILReadEncoderTimebase_channels
	  section.data(3).logicalSrcIdx = 36;
	  section.data(3).dtTransOffset = 16;
	
	  ;% helicopter_with_feedback_P.HILWriteAnalog_channels
	  section.data(4).logicalSrcIdx = 37;
	  section.data(4).dtTransOffset = 19;
	
	  ;% helicopter_with_feedback_P.HILInitialize_encoder_channels
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_active
	  section.data(1).logicalSrcIdx = 42;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_with_feedback_P.HILInitialize_final_digital_out
	  section.data(2).logicalSrcIdx = 43;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_with_feedback_P.HILInitialize_initial_digital_o
	  section.data(3).logicalSrcIdx = 44;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_analog_input_
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_set_analog_output
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_set_analog_outp_e
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_set_analog_out_ex
	  section.data(11).logicalSrcIdx = 52;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_analog_outp_p
	  section.data(12).logicalSrcIdx = 53;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 54;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_clock_frequ_e
	  section.data(14).logicalSrcIdx = 55;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 56;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_clock_param_c
	  section.data(16).logicalSrcIdx = 57;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 58;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_digital_out_b
	  section.data(18).logicalSrcIdx = 59;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_digital_out_c
	  section.data(19).logicalSrcIdx = 60;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_digital_ou_c1
	  section.data(20).logicalSrcIdx = 61;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_digital_out_a
	  section.data(21).logicalSrcIdx = 62;
	  section.data(21).dtTransOffset = 20;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_digital_out_j
	  section.data(22).logicalSrcIdx = 63;
	  section.data(22).dtTransOffset = 21;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_digital_out_m
	  section.data(23).logicalSrcIdx = 64;
	  section.data(23).dtTransOffset = 22;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_encoder_count
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_set_encoder_param
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_set_other_outpu_l
	  section.data(28).logicalSrcIdx = 69;
	  section.data(28).dtTransOffset = 27;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_pwm_outputs_a
	  ...
	  ;% helicopter_with_feedback_P.HILInitialize_set_pwm_output_ap
	  section.data(32).logicalSrcIdx = 73;
	  section.data(32).dtTransOffset = 31;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_pwm_outputs_o
	  section.data(33).logicalSrcIdx = 74;
	  section.data(33).dtTransOffset = 32;
	
	  ;% helicopter_with_feedback_P.HILInitialize_set_pwm_params_at
	  ...
	  ;% helicopter_with_feedback_P.Gain_Gain
	  section.data(3).logicalSrcIdx = 79;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_with_feedback_P.Gain1_Gain
	  ...
	  ;% helicopter_with_feedback_P.Gain_Gain_l
	  ...
	  ;% helicopter_with_feedback_P.Gain1_Gain_d
	  ...
	  ;% helicopter_with_feedback_P.Gain_Gain_a
	  section.data(10).logicalSrcIdx = 86;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_with_feedback_P.Gain1_Gain_b
	  ...
	  ;% helicopter_with_feedback_P.Gain1_Gain_f
	  ...
	  ;% helicopter_with_feedback_P.Gain_Gain_a1
	  ...
	  ;% helicopter_with_feedback_P.HILReadEncoderTimebase_Active
	  section.data(1).logicalSrcIdx = 111;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_with_feedback_P.HILWriteAnalog_Active
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (helicopter_with_feedback_B)
    ;%
      section.nData     = 21;
	  ...
	  ;% helicopter_with_feedback_B.Gain1
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 3;
	  ...
	  ;% helicopter_with_feedback_B.Gain_e
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 5;
	  ...
	  ;% helicopter_with_feedback_B.Gain1_e
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 7;
	  ...
	  ;% helicopter_with_feedback_B.Gain1_g
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 10;
	  ...
	  ;% helicopter_with_feedback_B.Sum4
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 14;
	  ...
	  ;% helicopter_with_feedback_B.K_ei
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 18;
	
	  ;% helicopter_with_feedback_B.Gain_l
	  section.data(19).logicalSrcIdx = 18;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (helicopter_with_feedback_DW)
    ;%
      section.nData     = 13;
      section.data(13)  = dumData; %prealloc
      
	  ;% helicopter_with_feedback_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 8;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 16;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 24;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 32;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 40;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_POSortedFreqs
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 48;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_POValues
	  section.data(8).logicalSrcIdx = 7;
	  ...
	  ;% helicopter_with_feedback_DW.LastUAtTimeA
	  section.data(10).logicalSrcIdx = 9;
	  ...
	  ;% helicopter_with_feedback_DW.LastUAtTimeB
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 67;
	
	  ;% helicopter_with_feedback_DW.HILWriteAnalog_Buffer
	  section.data(13).logicalSrcIdx = 12;
	  ...
	  ;% helicopter_with_feedback_DW.ToWorkspace_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 15;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_with_feedback_DW.ToWorkspace1_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 16;
	  section.data(2).dtTransOffset = 1;
	
	  ;% helicopter_with_feedback_DW.ToWorkspace4_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_with_feedback_DW.Travel_PWORK.LoggedData
	  ...
	  ;% helicopter_with_feedback_DW.Vd_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 21;
	  section.data(7).dtTransOffset = 6;
	
	  ;% helicopter_with_feedback_DW.Vs_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 22;
	  section.data(8).dtTransOffset = 7;
	
	  ;% helicopter_with_feedback_DW.p_ref_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 23;
	  section.data(9).dtTransOffset = 8;
	
	  ;% helicopter_with_feedback_DW.ElevationScopedegs_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 24;
	  section.data(10).dtTransOffset = 9;
	
	  ;% helicopter_with_feedback_DW.ElevationScopedeg_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 25;
	  section.data(11).dtTransOffset = 10;
	
	  ;% helicopter_with_feedback_DW.PitchScopedeg_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 26;
	  section.data(12).dtTransOffset = 11;
	
	  ;% helicopter_with_feedback_DW.PtichrateScopedegs_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 27;
	  section.data(13).dtTransOffset = 12;
	
	  ;% helicopter_with_feedback_DW.PtichrateScopedegs1_PWORK.LoggedData
	  section.data(14).logicalSrcIdx = 28;
	  section.data(14).dtTransOffset = 13;
	
	  ;% helicopter_with_feedback_DW.TravelrateScopedegs_PWORK.LoggedData
	  section.data(15).logicalSrcIdx = 29;
	  section.data(15).dtTransOffset = 14;
	
	  ;% helicopter_with_feedback_DW.TravelScopedeg_PWORK.LoggedData
	  section.data(16).logicalSrcIdx = 30;
	  section.data(16).dtTransOffset = 15;
	
	  ;% helicopter_with_feedback_DW.Backmotor_PWORK.LoggedData
	  section.data(17).logicalSrcIdx = 31;
	  section.data(17).dtTransOffset = 16;
	
	  ;% helicopter_with_feedback_DW.Frontmotor_PWORK.LoggedData
	  section.data(18).logicalSrcIdx = 32;
	  section.data(18).dtTransOffset = 17;
	
	  ;% helicopter_with_feedback_DW.HILWriteAnalog_PWORK
	  section.data(19).logicalSrcIdx = 33;
	  section.data(19).dtTransOffset = 18;
	
	  ;% helicopter_with_feedback_DW.ToWorkspace2_PWORK.LoggedData
	  section.data(20).logicalSrcIdx = 34;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_with_feedback_DW.ToWorkspace3_PWORK.LoggedData
	  ...
	  ;% helicopter_with_feedback_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 36;
	  section.data(1).dtTransOffset = 0;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 37;
	  section.data(2).dtTransOffset = 3;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 38;
	  section.data(3).dtTransOffset = 11;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 39;
	  section.data(4).dtTransOffset = 19;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 40;
	  section.data(5).dtTransOffset = 27;
	
	  ;% helicopter_with_feedback_DW.HILInitialize_POPolarityVals
	  section.data(6).logicalSrcIdx = 41;
	  section.data(6).dtTransOffset = 35;
	
	  ;% helicopter_with_feedback_DW.HILReadEncoderTimebase_Buffer
	  ...
	  ;% helicopter_with_feedback_DW.HILInitialize_POSortedChans
  ...
  targMap.checksum0 = 1366088435;
  targMap.checksum1 = 1392571513;
  targMap.checksum2 = 2755320153;
  targMap.checksum3 = 3976134373;
