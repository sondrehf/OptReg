...
MODEL                = helicopter_with_feedback
MODULES              = helicopter_with_feedback_data.c helicopter_with_feedback_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = helicopter_with_feedback.mk
...
MODELLIB                  = helicopter_with_feedbacklib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = helicopter_with_feedback_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\helicopter_with_feedback_quarc_win64
