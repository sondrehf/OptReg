...
#ifndef RTW_HEADER_helicopter_with_feedback_h_
#define RTW_HEADER_helicopter_with_feedback_h_
#include <math.h>
#include <string.h>
#ifndef helicopter_with_feedback_COMMON_INCLUDES_
# define helicopter_with_feedback_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter_with_feedback_COMMON_INCLUDES_ */

#include "helicopter_with_feedback_types.h"
...
#define helicopter_with_feedback_rtModel RT_MODEL_helicopter_with_feed_T
...
typedef struct {
  ...
  real_T ElevationTransferFcn_CSTATE;  /* '<S7>/Elevation: Transfer Fcn' */
  real_T Integrator_CSTATE;            /* '<S6>/Integrator' */
} XDot_helicopter_with_feedback_T;
...
} XDis_helicopter_with_feedback_T;
...
#define rtB                            helicopter_with_feedback_B
#define BlockIO                        B_helicopter_with_feedback_T
#define rtX                            helicopter_with_feedback_X
#define ContinuousStates               X_helicopter_with_feedback_T
#define rtXdot                         helicopter_with_feedback_XDot
#define StateDerivatives               XDot_helicopter_with_feedback_T
#define tXdis                          helicopter_with_feedback_XDis
#define StateDisabled                  XDis_helicopter_with_feedback_T
#define rtP                            helicopter_with_feedback_P
#define Parameters                     P_helicopter_with_feedback_T
#define rtDWork                        helicopter_with_feedback_DW
#define D_Work                         DW_helicopter_with_feedback_T

/* Parameters (auto storage) */
struct P_helicopter_with_feedback_T_ {
  real_T K_T[12];                      /* Variable: K_T
...
struct tag_RTM_helicopter_with_feedb_T {
  const char_T *path;
...
extern P_helicopter_with_feedback_T helicopter_with_feedback_P;

/* Block signals (auto storage) */
extern B_helicopter_with_feedback_T helicopter_with_feedback_B;

/* Continuous states (auto storage) */
extern X_helicopter_with_feedback_T helicopter_with_feedback_X;

/* Block states (auto storage) */
extern DW_helicopter_with_feedback_T helicopter_with_feedback_DW;

/* Model entry point functions */
extern void helicopter_with_feedback_initialize(void);
extern void helicopter_with_feedback_output(void);
extern void helicopter_with_feedback_update(void);
extern void helicopter_with_feedback_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_with_feedback_rtModel *helicopter_with_feedback(void);
...
extern RT_MODEL_helicopter_with_feed_T *const helicopter_with_feedback_M;
 ...
 *
 * '<Root>' : 'helicopter_with_feedback'
 * '<S1>'   : 'helicopter_with_feedback/Conversion'
 * '<S2>'   : 'helicopter_with_feedback/Degrees to Radians'
 * '<S3>'   : 'helicopter_with_feedback/Degrees to Radians1'
 * '<S4>'   : 'helicopter_with_feedback/Degrees to Radians2'
 * '<S5>'   : 'helicopter_with_feedback/Degrees to Radians3'
 * '<S6>'   : 'helicopter_with_feedback/Elevation controller'
 * '<S7>'   : 'helicopter_with_feedback/Helicopter_interface'
 * '<S8>'   : 'helicopter_with_feedback/LQR-controller'
 * '<S9>'   : 'helicopter_with_feedback/Pitch controller'
 * '<S10>'  : 'helicopter_with_feedback/Helicopter_interface/Elevation rad to deg'
 * '<S11>'  : 'helicopter_with_feedback/Helicopter_interface/Elevation rate rad to deg'
 * '<S12>'  : 'helicopter_with_feedback/Helicopter_interface/Pitch rad to deg'
 * '<S13>'  : 'helicopter_with_feedback/Helicopter_interface/Pitch rate rad to deg'
 * '<S14>'  : 'helicopter_with_feedback/Helicopter_interface/Pitch rate rad to deg1'
 * '<S15>'  : 'helicopter_with_feedback/Helicopter_interface/Travel rad to deg'
 * '<S16>'  : 'helicopter_with_feedback/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_with_feedback_h_ */
