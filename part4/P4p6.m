...
ylabel('\lambda[rad]')
title('Optimal $\lambda$ vs actual $\lambda$ (with feedback and $-0.4<\dot{\lambda}<0.4$)', 'Interpreter', 'Latex');
xlim([0 25])
...
xlabel('$t[sec]$', 'Interpreter', 'Latex');
ylabel('p[rad]')
title('Optimal $p$ vs actual $p$ (with feedback and $-0.4<\dot{\lambda}<0.4$)', 'Interpreter', 'Latex');
xlim([0 25])
ylim([-0.5 0.6])
...
xlabel('$t[sec]$', 'Interpreter', 'Latex');
ylabel('e[rad]')
title('Optimal $e$ vs actual $e$ (with feedback and $-0.4<\dot{\lambda}<0.4$)', 'Interpreter', 'Latex');
xlim([0 25])
ylim([-0.2 0.3])
...
xlabel('$t[sec]$', 'Interpreter', 'Latex');
ylabel('\lambda[rad]')
title('Optimal $\lambda$ vs actual $\lambda$ ', 'Interpreter', 'Latex');
xlim([0 25])
