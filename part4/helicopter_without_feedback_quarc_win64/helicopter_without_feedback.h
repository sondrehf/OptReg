...
#ifndef RTW_HEADER_helicopter_without_feedback_h_
#define RTW_HEADER_helicopter_without_feedback_h_
#include <math.h>
#include <string.h>
#ifndef helicopter_without_feedback_COMMON_INCLUDES_
# define helicopter_without_feedback_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* helicopter_without_feedback_COMMON_INCLUDES_ */

#include "helicopter_without_feedback_types.h"
...
#define helicopter_without_feedback_rtModel RT_MODEL_helicopter_without_f_T
...
} B_helicopter_without_feedback_T;
...
} DW_helicopter_without_feedbac_T;
...
} X_helicopter_without_feedback_T;
...
typedef struct {
  ...
  real_T ElevationTransferFcn_CSTATE;  /* '<S7>/Elevation: Transfer Fcn' */
  real_T Integrator_CSTATE;            /* '<S6>/Integrator' */
} XDot_helicopter_without_feedb_T;
...
} XDis_helicopter_without_feedb_T;
...
#define rtB                            helicopter_without_feedback_B
#define BlockIO                        B_helicopter_without_feedback_T
#define rtX                            helicopter_without_feedback_X
#define ContinuousStates               X_helicopter_without_feedback_T
#define rtXdot                         helicopter_without_feedbac_XDot
#define StateDerivatives               XDot_helicopter_without_feedb_T
#define tXdis                          helicopter_without_feedbac_XDis
#define StateDisabled                  XDis_helicopter_without_feedb_T
#define rtP                            helicopter_without_feedback_P
#define Parameters                     P_helicopter_without_feedback_T
#define rtDWork                        helicopter_without_feedback_DW
#define D_Work                         DW_helicopter_without_feedbac_T

/* Parameters (auto storage) */
struct P_helicopter_without_feedback_T_ {
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T elavation_offsetdeg1_Value;   /* Expression: 180
...
struct tag_RTM_helicopter_without_fe_T {
  const char_T *path;
...
extern P_helicopter_without_feedback_T helicopter_without_feedback_P;

/* Block signals (auto storage) */
extern B_helicopter_without_feedback_T helicopter_without_feedback_B;

/* Continuous states (auto storage) */
extern X_helicopter_without_feedback_T helicopter_without_feedback_X;

/* Block states (auto storage) */
extern DW_helicopter_without_feedbac_T helicopter_without_feedback_DW;

/* Model entry point functions */
extern void helicopter_without_feedback_initialize(void);
extern void helicopter_without_feedback_output(void);
extern void helicopter_without_feedback_update(void);
extern void helicopter_without_feedback_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern helicopter_without_feedback_rtModel *helicopter_without_feedback(void);
...
extern RT_MODEL_helicopter_without_f_T *const helicopter_without_feedback_M;
 ...
 *
 * '<Root>' : 'helicopter_without_feedback'
 * '<S1>'   : 'helicopter_without_feedback/Conversion'
 * '<S2>'   : 'helicopter_without_feedback/Degrees to Radians'
 * '<S3>'   : 'helicopter_without_feedback/Degrees to Radians1'
 * '<S4>'   : 'helicopter_without_feedback/Degrees to Radians2'
 * '<S5>'   : 'helicopter_without_feedback/Degrees to Radians3'
 * '<S6>'   : 'helicopter_without_feedback/Elevation controller'
 * '<S7>'   : 'helicopter_without_feedback/Helicopter_interface'
 * '<S8>'   : 'helicopter_without_feedback/Pitch controller'
 * '<S9>'   : 'helicopter_without_feedback/Helicopter_interface/Elevation rad to deg'
 * '<S10>'  : 'helicopter_without_feedback/Helicopter_interface/Elevation rate rad to deg'
 * '<S11>'  : 'helicopter_without_feedback/Helicopter_interface/Pitch rad to deg'
 * '<S12>'  : 'helicopter_without_feedback/Helicopter_interface/Pitch rate rad to deg'
 * '<S13>'  : 'helicopter_without_feedback/Helicopter_interface/Pitch rate rad to deg1'
 * '<S14>'  : 'helicopter_without_feedback/Helicopter_interface/Travel rad to deg'
 * '<S15>'  : 'helicopter_without_feedback/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_without_feedback_h_ */
