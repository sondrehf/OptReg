  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% helicopter_DW.ToWorkspace4_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 17;
	  section.data(3).dtTransOffset = 2;
	
	  ;% helicopter_DW.Travel_PWORK.LoggedData
	  ...
	  ;% helicopter_DW.ToWorkspace2_PWORK.LoggedData
	  section.data(20).logicalSrcIdx = 34;
	  section.data(20).dtTransOffset = 19;
	
	  ;% helicopter_DW.ToWorkspace3_PWORK.LoggedData
  ...
  targMap.checksum0 = 876513397;
  targMap.checksum1 = 3976198847;
  targMap.checksum2 = 1947165900;
  targMap.checksum3 = 2812489427;
